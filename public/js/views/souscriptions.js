  ...
  async function openForm(row) {
    ...
    formModal({
      ...
      fields: [
        ...
        { name: 'montant_loyer', label: 'Montant du loyer', type: 'number', required: true, min: 1, step: 1, hint: 'Modifiable : chaque locataire peut avoir son propre loyer.' },
        ...
        { name: 'montant_caution', label: 'Montant caution', type: 'number', min: 0, step: 1, hint: 'À saisir manuellement.' },
        ...
        { name: 'montant_avance', label: 'Montant avance', type: 'number', min: 0, step: 1, hint: 'À saisir manuellement.' },
        ...
        { name: 'montant_garantie', label: 'Montant garantie', type: 'number', min: 0, step: 1, hint: 'À saisir manuellement.' },
